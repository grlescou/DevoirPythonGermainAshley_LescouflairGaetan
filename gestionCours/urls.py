...
urlpatterns = patterns('',
    ...
    ##
    ## Url Pour la partie Utilisateur
    url(r'^admin_login/', 'gestionCours.views.loginPage', name='loginPage'),
     url(r'^admin_login_validation/', 'gestionCours.views.login', name='login'),
      url(r'^admin_logout/', 'gestionCours.views.logout', name='logout'),
    url(r'^utilisateur_ajouter/', 'gestionCours.views.admin_utilisateur_ajouter', name='admin_utilisateur_ajouter'),
    url(r'^admin_listing_utilisateur/', 'gestionCours.views.admin_listing_utilisateur', name='admin_listing_utilisateur'),
    url(r'^admin_utilisateur_changer_password/', 'gestionCours.views.admin_utilisateur_changer_password', name='admin_utilisateur_changer_password'),

    url(r'admin_supression_Utilisateur/', 'gestionCours.views.admin_supression_Utilisateur', name='admin_supression_Utilisateur'),
         url(r'admin_supression_Utilisateur_getInfo/', 'gestionCours.views.admin_supression_Utilisateur_getInfo', name='admin_supression_Utilisateur_getInfo'),
          url(r'admin_supression_Utilisateur_Update/', 'gestionCours.views.admin_supression_Utilisateur_Update', name='admin_supression_Utilisateur_Update'),
